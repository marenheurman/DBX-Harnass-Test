...
Requirements:
  ...
  - Read docs/model-manifest.json for exact table/column/measure names.
...
def make_chart(vid: str, x: int, y: int, w: int, h: int,
    ...
    Args:
        ...
        measure_name:   Exact measure name (see model-manifest.json).
...
def make_page(page_name: str, display_name: str, ordinal: int,
    ...
    Args:
        ...
        width/height: Canvas size in pixels. Default 1280 × 720.
    """
    return {
        "id": ordinal,
        "name": page_name,
