...
| Build report pages or add visuals to a .pbix | `.agents/skills/report-build/skill.md` | `docs/pbix-layout-format.md`, `docs/tooling-decision.md`, `rules/safety-rules.md` | `templates/build-report-template.py` | — |
